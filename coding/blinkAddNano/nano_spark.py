...
from nano_calculator_solve2 import nano_core, cal_ryr_cca
...
def loop(total_steps, do_save, dir_name, is_continue):
    ...
    for i in range(current_step, total_steps + 1):
        ...
        nano_c_ca, nano_c_cag, nano_c_cam, nano_c_trc, nano_c_srm, nano_c_slm, ryr_cca = \
            nano_core(nano_c_ca, nano_c_cag, nano_c_cam, nano_c_trc, nano_c_srm, nano_c_slm, c_ca_jsr,
                      k_ryr)
